        ...
        <div class="flex flex-col gap-2 mb-4 sm:flex-row sm:items-center sm:justify-between">
            ...
            <div class="flex items-center gap-3">
                ...
                <router-link :to="createSalesInvoice" >
                    <Button size="sm" variant="primary"> Create Sales Invoice </Button>
                </router-link>
            </div>
        </div>
            ...
            <table class="min-w-full">
                <thead>
                    <tr class="border-t border-gray-100 dark:border-gray-800">
                        ...
                        <th class="py-3 text-left">
                            <p class="font-medium text-gray-500 text-theme-xs dark:text-gray-400">Invoice Number</p>
                        </th>
                        <th class="py-3 text-left">
                ...
                <tbody>
                    <tr v-for="(invoice, index) in invoices" :key="index"
                        @click="handleInvoiceOpen(invoice)"
