<template>
  <aside :class="[
    ...
    <div :class="[
      ...
      <router-link to="/">
        <QikBillIcon v-if="isExpanded || isHovered || isMobileOpen" :showText="true" />
        <QikBillIcon v-else :showText="false" />
      </router-link>
    </div>
...
const menuGroups = [
  {
    ...
    items: [
      ...
      },
      {
        ...
        name: "Sales",
        subItems: [
          { name: "Sales Invoice", path: routeConstants.SALES_INVOICE, pro: false },
          { name: "Quotation Estimate", path: routeConstants.QUOTATION_ESTIMATE, pro: false },
          { name: "Payment In", path: routeConstants.PAYMENT_IN, pro: false },
          { name: "Sales Return", path: routeConstants.SALES_RETURN, pro: false },
        ],
      },
      {
        ...
        name: "Purchase",
        subItems: [
          { name: "Purchase Invoices", path: routeConstants.PURCHASE_INVOICE, pro: false },
          { name: "Payment Out", path: routeConstants.PAYMENT_OUT, pro: false },
          { name: "Purchase Return", path: routeConstants.PURCHASE_RETURN, pro: false },
        ],
      },
      {
        icon: ReportIcon,
