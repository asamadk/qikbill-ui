            ...
            <table class="min-w-full">
                <thead>
                    <tr class="border-t border-gray-100 dark:border-gray-800">
                        ...
                        <th class="py-3 text-left">
                            <p class="font-medium text-gray-500 text-theme-xs dark:text-gray-400">Payment Number</p>
                        </th>
                        <th class="py-3 text-left">
                ...
                <tbody>
                    <tr v-for="(invoice, index) in invoices" :key="index" @click="handleInvoiceOpen(invoice)"
                        ...
                        <td class="py-3 whitespace-nowrap">
                            <p class="text-gray-500 text-theme-sm dark:text-gray-400">{{ invoice.payment_number }}</p>
                        </td>
                        <td class="py-3 whitespace-nowrap">
