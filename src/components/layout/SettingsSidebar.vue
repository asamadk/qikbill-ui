<template>
    <aside :class="[
        ...
        <div :class="[
            ...
            <router-link to="/">
                <div class="flex">
                    <BackIcon class="p-1 rounded-lg hover:bg-brand-50" />
                    <p class="font-semibold text-lg ml-2">Back to Dashboard</p>
                </div>
            </router-link>
        </div>
        <div class="flex flex-col overflow-y-auto duration-300 ease-linear no-scrollbar">
            ...
            <!-- logout -->
            <div class="flex p-2 cursor-pointer hover:bg-red-50 rounded-xl mb-2">
                <span class="text-red-400">
                    <LogoutIcon />
                </span>
                <span class="menu-item-text text-sm ml-2">
                    Logout
                </span>
            </div>
