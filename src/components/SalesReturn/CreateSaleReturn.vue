<template>
    <admin-layout>
        <div
            ...
            <PageBreadcrumb :backPath="saleReturnEndpoint" :showBackButton="true" path="Sale sReturn" pageTitle="Create Sales Return" />
            <InvoiceForm />
...
import InvoiceForm from '../Sales/InvoiceForm.vue';
...
export default {
    ...
    data() {
        return {
            saleReturnEndpoint: routeConstants.SALES_RETURN
        }
    }
